...
const GSTBilling = () => {
    ...
    const [discountPercentage, setDiscountPercentage] = useState(0); // State for storing the selected discount percentage
    const [grandTotal, setGrandTotal] = useState(0); // State for storing the calculated Grand Total
    ...
    useEffect(() => {
        if (order && Items) {
            ...
            const discountAmount = (180 * discountPercentage) / 100;
            const calculatedGrandTotal = 180 - discountAmount;
            setGrandTotal(calculatedGrandTotal);
        }
    }, [order, discountPercentage]);

    // Event handler for the discount dropdown change
                        ...
                        <Row>
                            ...
                            <Table responsive className='bill-table'>
                                ...
                                <div className='total-bill'>
                                    <p >Total <span className='float-end'>180.00</span></p>
                                    ...
                                    <p>Discount: <span className='float-end'>{180 > 0 ? (180 * (discountPercentage / 100)).toFixed(2) : '0.00'}</span></p>
                                    <p>Grand Total <span className='float-end'>{grandTotal.toFixed(2)}</span></p>
